	 ...
	 */
	export var RectangularSensorVisualizer = function(this:any, scene, entityCollection) {
	...
	RectangularSensorVisualizer.prototype.update = function(time) {
		...
		for (var i = 0, len = entities.length; i < len; i++) {
			...
			primitive.lateralSurfaceMaterial = (MaterialProperty as any).getValue(time, rectangularSensorGraphics._lateralSurfaceMaterial, primitive.lateralSurfaceMaterial);
	 ...
	 * @private
	 */
	RectangularSensorVisualizer.prototype._onCollectionChanged = function(_, added, removed, changed) {
		var i;
		var entity;
