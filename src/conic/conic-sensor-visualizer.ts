	 ...
	 */
	export function ConicSensorVisualizer (this:any, scene, entityCollection) {
	...
	ConicSensorVisualizer.prototype.update = function(time) {
		...
		for (var i = 0, len = entities.length; i < len; i++) {
			...
			primitive.lateralSurfaceMaterial = (MaterialProperty as any).getValue(time, conicSensorGraphics._lateralSurfaceMaterial, primitive.lateralSurfaceMaterial);
	 ...
	 * @private
	 */
	ConicSensorVisualizer.prototype._onCollectionChanged = function(_, added, removed, changed) {
		var i;
		var entity;
