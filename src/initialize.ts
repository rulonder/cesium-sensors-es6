	...
	function processDirectionData(customPatternSensor:any, directions:any, interval:any, sourceUri:any, entityCollection:any) {
		var i;
		var len;
		var values:any[] = [];
	...
	function processCommonSensorProperties(sensor, sensorData, interval, sourceUri, entityCollection) {
		...
		processPacketData(Color as any, sensor, 'intersectionColor', sensorData.intersectionColor, interval, sourceUri, entityCollection);
	...
	export function initialize() {
		...
		var originalDefaultVisualizersCallback :any = DataSourceDisplay.defaultVisualizersCallback;
