	 ...
	 */
	export var CustomPatternSensorVisualizer = function(this:any, scene, entityCollection) {
	...
	CustomPatternSensorVisualizer.prototype.update = function(time) {
		...
		for (var i = 0, len = entities.length; i < len; i++) {
			...
			primitive.lateralSurfaceMaterial = (MaterialProperty as any).getValue(time, customPatternSensorGraphics._lateralSurfaceMaterial, primitive.lateralSurfaceMaterial);
	 ...
	 * @private
	 */
	CustomPatternSensorVisualizer.prototype._onCollectionChanged = function(_, added, removed, changed) {
		var i;
		var entity;
